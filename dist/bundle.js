...
var RailWrapper = styled__default["default"].div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  overflow: hidden;\n  ", "\n"], ["\n  overflow: hidden;\n  ", "\n"])), function (_a) {
    var scrollable = _a.scrollable, scrollSnap = _a.scrollSnap, gap = _a.gap;
    return scrollable
...
function Carousel(_a) {
    var _b = _a.cols, colsProp = _b === void 0 ? 1 : _b, _c = _a.rows, rowsProp = _c === void 0 ? 1 : _c, _d = _a.gap, gapProp = _d === void 0 ? 10 : _d, _e = _a.loop, loopProp = _e === void 0 ? false : _e, _f = _a.scrollable, scrollable = _f === void 0 ? false : _f, _g = _a.scrollSnap, scrollSnap = _g === void 0 ? true : _g, _h = _a.hideArrow, hideArrow = _h === void 0 ? false : _h, arrowLeft = _a.arrowLeft, arrowRight = _a.arrowRight, containerClassName = _a.containerClassName, containerStyle = _a.containerStyle, children = _a.children, _j = _a.startPage, startPage = _j === void 0 ? 0 : _j, onPageChanged = _a.onPageChanged, onTotalPagesChanged = _a.onTotalPagesChanged;
    var _k = react.useState(startPage), currentPage = _k[0], setCurrentPage = _k[1];
    var _l = react.useState(colsProp), cols = _l[0], setCols = _l[1];
    var _m = react.useState(rowsProp), rows = _m[0], setRows = _m[1];
    var _o = react.useState(0), gap = _o[0], setGap = _o[1];
    var _p = react.useState(loopProp), loop = _p[0], setLoop = _p[1];
    ...
    return (jsxRuntime.jsxs(Container, __assign({ className: containerClassName, style: containerStyle }, { children: [jsxRuntime.jsx(ArrowButton, { type: "prev", hidden: !scrollable && (hideArrow || (!loop && currentPage <= 0)), CustomBtn: arrowLeft, onClick: handlePrev }), jsxRuntime.jsx(RailWrapper, __assign({ gap: gap, scrollable: scrollable, scrollSnap: scrollSnap, ref: railWrapperRef }, { children: scrollable ? (itemSetList.map(function (sets, i) { return jsxRuntime.jsx(react.Fragment, { children: sets }, i); })) : (jsxRuntime.jsx(Rail, __assign({ cols: cols, rows: rows, page: page, gap: gap, currentPage: currentPage }, { children: itemSetList.map(function (sets, i) { return (jsxRuntime.jsx(ItemSet, __assign({ cols: cols, rows: rows, gap: gap }, { children: sets }), i)); }) }))) })), jsxRuntime.jsx(ArrowButton, { type: "next", hidden: !scrollable && (hideArrow || (!loop && currentPage === page - 1)), CustomBtn: arrowRight, onClick: handleNext })] })));
}
